...
export const KimiIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 32 32" className={cn("fill-none", className)}>
    ...
    <path
      d="M8 10.5C8 9.67157 8.67157 9 9.5 9H11.5C12.3284 9 13 9.67157 13 10.5V21.5C13 22.3284 12.3284 23 11.5 23H9.5C8.67157 23 8 22.3284 8 21.5V10.5Z"
      fill="#10B981"
    />
    <path
      d="M15 14.5C15 13.6716 15.6716 13 16.5 13H18.5C19.3284 13 20 13.6716 20 14.5V21.5C20 22.3284 19.3284 23 18.5 23H16.5C15.6716 23 15 22.3284 15 21.5V14.5Z"
      fill="#10B981"
    />
    <path
      d="M22 17.5C22 16.6716 22.6716 16 23.5 16H25.5C26.3284 16 27 16.6716 27 17.5V21.5C27 22.3284 26.3284 23 25.5 23H23.5C22.6716 23 22 22.3284 22 21.5V17.5Z"
      fill="#10B981"
    />
  </svg>
);
