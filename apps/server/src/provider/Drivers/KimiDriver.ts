/**
 * KimiDriver — `ProviderDriver` for the Kimi Code runtime.
 *
 * Wraps the Kimi Code CLI (`kimi`) in stream-json mode.
 *
    ...
    Effect.gen(function* () {
      ...
      const snapshot = yield* makeManagedServerProvider<KimiSettings>({
        ...
        initialSnapshot: (settings) =>
          makePendingKimiProvider(settings).pipe(Effect.map(stampIdentity)),
        checkProvider,
